...
Remember: Your output will be used directly by the parent agent. Provide complete, actionable information including the exact story key and file path for the next sub-agent to process.
